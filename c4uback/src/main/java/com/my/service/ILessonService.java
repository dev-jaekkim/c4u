...
public interface ILessonService {
	 ...
	 */
	Lesson findById(int lessonId) throws FindException;
	 ...
	 */
	List<Lesson> findByUnion(String union) throws FindException;
	 ...
	 */
	List<Lesson> findByUnionPerPage(String union, int currentPage, int cnt_per_page) throws FindException;
	 ...
	 */
	int findByTeacherIdCnt(int studentId) throws FindException;
