...
public interface IQNAService {
	 ...
	 */
	List<QNA> findPerPage(int currentPage, int cnt_per_page) throws FindException;
	 ...
	 */
	List<QNA> findByStudentIdPerPage(int student_id, int currentPage, int cnt_per_page) throws FindException;
	 ...
	 * @throws FindException 닉네임이 일치하는 1:1 문의가 없을 경우, 예외가 발생한다. 
	 */
	List<QNA> findByNameOrTitleOrContentPerPage(String word, int currentPage, int cnt_per_page) throws FindException;
	 ...
	 */
	QNA findById(int qna_id) throws FindException;
	 ...
	 */
	QNA findById(int qna_id, Student student) throws FindException;
	 ...
	 */
	QNA modify(QNA qna) throws ModifyException;
	 ...
	 */
	int remove(int qna_id) throws RemoveException;
}
